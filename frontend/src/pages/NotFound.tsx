...
import { FileText, Home, Search, ArrowLeft, Sparkles } from 'lucide-react';
        ...
        <div className="min-h-screen bg-linear-to-br from-blue-50 via-purple-50 to-pink-50 relative overflow-hidden flex items-center justify-center p-4">
            ...
            <div className="relative z-10 max-w-2xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                    ...
                    <button className="px-8 py-4 bg-white/80 backdrop-blur-sm text-purple-600 rounded-xl font-semibold hover:shadow-xl border-2 border-purple-200 hover:border-purple-400 transform hover:scale-105 transition-all flex items-center space-x-2">
                ...
                <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border-2 border-purple-100 shadow-lg">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button className="flex items-center space-x-2 px-4 py-3 bg-purple-50 hover:bg-purple-100 rounded-lg transition-colors text-left">
